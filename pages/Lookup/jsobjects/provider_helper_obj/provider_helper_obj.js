export default {
	update_preferred_payment_method: async (provider_id, new_ppm) => {
		try {
			...
			await log.run({action_type: constants.update_provider_preferred_payment_method, ref_id: provider_lookup_table.triggeredRow["Provider NPI"], ref_id_type: constants.npi, change_json: JSON.stringify({"Preferred Payment Method Before": provider_lookup_table.triggeredRow["Preferred Payment Method"], "Preferred Payment Method After": new_ppm}) });					
